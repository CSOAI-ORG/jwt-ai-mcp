...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/jwt_ai_mcp/)

> MEOK AI Labs — JWT token operations — decode, validate, generate, inspect
...
```bash
# Install via pip
pip install jwt_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install jwt-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/jwt-ai-mcp)
